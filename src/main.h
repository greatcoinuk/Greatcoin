...
static const int64_t MAX_MONEY = 97000000 * COIN; //newtodo1
...
public:
    ...
    {
        // Greatcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Greatcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Greatcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Greatcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Greatcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Greatcoin: block index flags
    enum  
    {
