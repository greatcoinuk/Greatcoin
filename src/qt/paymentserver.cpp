...
const QString BITCOIN_IPC_PREFIX("Greatcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Greatcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Greatcoin: click-to-pay handler");
    else
...
{
    // clicking on Greatcoin: URLs creates FileOpen events on the Mac:
